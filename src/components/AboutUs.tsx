...
export const AboutUs: React.FC = () => {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 bg-[#0F172A] relative overflow-hidden">
      {/* Background ambient light effects with smooth animations */}
      <motion.div
        animate={{ scale: [1, 1.2, 1], opacity: [0.1, 0.2, 0.1] }}
        transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute top-1/2 left-0 w-[500px] max-w-full h-[500px] bg-amber-500/10 rounded-full blur-[140px] pointer-events-none -translate-y-1/2"
      />
      <motion.div
        animate={{ scale: [1.2, 1, 1.2], opacity: [0.15, 0.05, 0.15] }}
        transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute bottom-0 right-0 w-[500px] max-w-full h-[500px] bg-orange-600/10 rounded-full blur-[140px] pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden glass-card p-3 sm:p-4 border border-slate-700/80 shadow-2xl group hover:border-orange-500/50 transition-all duration-500">
              
              {/* Card Frame with Scenic Highway Backdrop & Glowing Crest */}
              <div className="relative aspect-auto sm:aspect-square lg:aspect-[4/5] rounded-2xl bg-gradient-to-br from-slate-900 via-slate-950 to-black overflow-hidden flex flex-col items-center justify-center p-6 text-center border border-slate-800 py-10 sm:py-6">
                ...
                <div className="relative z-10 space-y-5 flex flex-col items-center">
                  ...
                  <motion.div
                    ...
                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-tr from-orange-500 via-amber-500 to-yellow-400 p-1 shadow-2xl shadow-orange-500/30 relative"
                  >
                    <div className="w-full h-full rounded-full bg-slate-950 flex flex-col items-center justify-center border border-slate-800">
                      <Car className="w-8 h-8 sm:w-10 sm:h-10 text-amber-400" />
                    </div>
                    {/* Glowing pulse ring */}
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] sm:text-xs font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-300 uppercase tracking-widest">
                  ...
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-slate-700/80 text-xs font-medium text-slate-200 shadow-md">
                    ...
                    <span>Based at Katipalla, Mangalore</span>
                  </div>

                  {/* Verification Features Badges */}
                  <div className="flex flex-wrap justify-center items-center gap-2 pt-1 text-[11px] text-slate-400">
                ...
                <div className="mt-4 sm:mt-0 sm:absolute sm:bottom-4 sm:right-4 bg-gradient-to-r from-orange-500 to-amber-600 px-3.5 py-1.5 rounded-xl text-white font-bold text-xs shadow-xl flex items-center gap-1.5 border border-amber-400/30">
          ...
          >
            <div className="space-y-4">
              <h3 className="text-xl sm:text-3xl font-bold text-white font-['Poppins']">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-2">
              {highlights.map((item, idx) => (
                <motion.div
                  ...
                  className="p-3.5 sm:p-4 rounded-xl bg-slate-900/70 border border-slate-800 hover:border-orange-500/40 hover:bg-slate-900/90 transition-all duration-300 flex items-start gap-3 group shadow-md"
                >
            ...
            >
              <div className="flex items-start sm:items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-emerald-900/60 border border-emerald-700/60 flex items-center justify-center flex-shrink-0 mt-0.5 sm:mt-0">
                  <MapPin className="w-5 h-5 text-emerald-400" />
                </div>
                <span className="leading-normal"><strong>Office Address:</strong> {BUSINESS_INFO.address.full}</span>
              </div>
              <a
                href={BUSINESS_INFO.googleMapsDirectionsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto text-center px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition-all shadow-md shadow-emerald-950/40 flex-shrink-0 hover:scale-105"
              >
                Get Directions
              </a>
            </motion.div>
